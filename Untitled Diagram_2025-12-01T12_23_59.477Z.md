...
| **quantity** | INTEGER | null |  |for packs, do not set if quantity = 1 like for a vehicle |
...
| **spec_id** | INTEGER | null | asset's spec's logs | | 
